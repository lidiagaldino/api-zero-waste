...
CREATE TABLE `tbl_pessoa_juridica` (
    ...
    INDEX `tbl_pessoa_juridica_id_usuario_fkey`(`id_usuario`),
    PRIMARY KEY (`id`)
...
CREATE TABLE `tbl_catador` (
    ...
    INDEX `tbl_catador_id_usuario_fkey`(`id_usuario`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `tbl_materiais_catador` (
    ...
    INDEX `tbl_materiais_catador_id_catador_fkey`(`id_catador`),
    INDEX `tbl_materiais_catador_id_materiais_fkey`(`id_materiais`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `tbl_endereco_usuario` (
    ...
    INDEX `tbl_endereco_usuario_id_endereco_fkey`(`id_endereco`),
    INDEX `tbl_endereco_usuario_id_usuario_fkey`(`id_usuario`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `tbl_gerador` (
    ...
    INDEX `tbl_gerador_id_usuario_fkey`(`id_usuario`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `tbl_favoritar_catador` (
    ...
    INDEX `tbl_favoritar_catador_id_catador_fkey`(`id_catador`),
    INDEX `tbl_favoritar_catador_id_gerador_fkey`(`id_gerador`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `tbl_materiais_pedido` (
    ...
    INDEX `tbl_materiais_pedido_id_material_fkey`(`id_material`),
    INDEX `tbl_materiais_pedido_id_pedido_fkey`(`id_pedido`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `tbl_pedido` (
    ...
    INDEX `tbl_pedido_id_catador_fkey`(`id_catador`),
    INDEX `tbl_pedido_id_endereco_fkey`(`id_endereco`),
    INDEX `tbl_pedido_id_gerador_fkey`(`id_gerador`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
